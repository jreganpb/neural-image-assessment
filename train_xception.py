...
from utilities.keras_data_loader import train_image_paths, train_y, val_image_paths, val_y, image_generator, train_wts, val_wts
...
model.fit_generator(image_generator(files=train_image_paths,scores=train_y,batch_size=batchsize,weights=train_wts),
